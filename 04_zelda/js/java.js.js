...
$(document).ready(function(){ 
    $('mainImg1').css('width', $(window).width()); 
    $('mainImg1').css('height', $(window).height()); 
...
$(".switch").mouseenter(function(){
	$(".mainBar").addClass("pinkBg");
    $(".switch span").addClass("enter");
    $(".button, .will").css({display:"none"});
}).mouseleave(function(){
	$(".mainBar").removeClass("pinkBg")	
    $(".switch span").removeClass("enter");
    $(".button, .will").css({display:"block"});    
});

$(".will").mouseenter(function(){
	$(".mainBar").addClass("blueBg");
    $(".will span").addClass("enter");    
    $(".switch, .button").css({display:"none"});
}).mouseleave(function(){
	$(".mainBar").removeClass("blueBg");
    $(".will span").removeClass("enter");
...
function particle(){
    ...
    canvas.height = 1002;
    img.src = "http://s.nx.com/s2/game/Tales/event/2019/0418_update/spr_particle.png";
